...
agent_briefs    (agent_id → agents, brief_date, payload_json, created_at)
                 -- cached morning brief, one per agent per UTC day (migration 007);
